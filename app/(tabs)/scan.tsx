    ...
    <SafeAreaProvider>
      <SafeAreaView className="h-full pb-7 items-center justify-center">
          ...
          <View className="gap-2 ">
            <Pressable onPress={() => {router.push("/scanReceipt")}} className="bg-primary-300 py-2 rounded-3xl  my-2 shadow-sm">
              <Text className="text-white font-bold text-lg text-center shadow-md">Take a Photo</Text>
            </Pressable>

            <Pressable onPress={() => {router.push("/importReceipt")}} className="bg-primary-200 px-10 py-2 rounded-3xl  my-2 shadow-sm">
              <Text className="text-white font-bold text-lg text-center shadow-md">Import Photo From Library</Text>
            </Pressable>

            <Pressable onPress={() => {router.push("/editReceipt")}} className="bg-primary-100 py-2 rounded-3xl my-2 shadow-sm">
